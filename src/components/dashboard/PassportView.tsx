...
export default function PassportView({ trip, userEmail }: PassportViewProps) {
  ...
  return (
    <div className="space-y-6 text-left max-w-6xl mx-auto font-sans max-w-full overflow-hidden">
      ...
      {!isPaid && (
        <div className="bg-amber-50/80 border border-amber-200 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-start sm:items-center gap-3 min-w-0">
            <div className="w-9 h-9 rounded-xl bg-amber-100 text-amber-800 font-bold flex items-center justify-center shrink-0 mt-0.5 sm:mt-0">
          ...
          <button
            ...
            className="w-full sm:w-auto shrink-0 px-4 py-2.5 bg-[#0FA958] hover:bg-[#0D8E4A] text-white text-xs font-bold rounded-xl shadow-xs transition-all active:scale-98 cursor-pointer flex items-center justify-center gap-1.5 whitespace-nowrap"
          >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200/80 pb-5">
        <div>
          <div className="flex items-center gap-1.5 text-xs text-zinc-500 mb-1 flex-wrap">
            <span>Pet Travel Compliance</span>
            <span>/</span>
            <span className="font-medium text-zinc-800">Verification Passport</span>
          </div>
          <h1 className="font-serif text-xl sm:text-2xl md:text-3xl font-bold text-zinc-900 tracking-tight leading-tight">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full sm:w-auto shrink-0">
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 bg-white hover:bg-zinc-50 disabled:opacity-75 border border-zinc-300 text-xs font-semibold text-zinc-700 px-4 py-2.5 rounded-xl shadow-2xs transition-colors cursor-pointer w-full sm:w-auto"
          >
            {isDownloadingPdf ? (
              <>
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-1.5 bg-[#0E2342] hover:bg-[#16345E] text-white text-xs font-semibold px-4 py-2.5 rounded-xl shadow-xs transition-all w-full sm:w-auto text-center"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-zinc-200/80 shadow-xs overflow-hidden">
            <div className="p-4 sm:p-6 border-b border-zinc-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
              <div className="flex items-start sm:items-center gap-3 sm:gap-4 min-w-0">
                <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-zinc-100 border border-zinc-200 text-[#0E2342] flex items-center justify-center shrink-0 mt-0.5 sm:mt-0">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    <h2 className="text-base sm:text-lg font-bold text-zinc-900 truncate">{pet.name}</h2>
                    <span className="px-2 py-0.5 rounded-md text-[10px] sm:text-[11px] font-semibold bg-zinc-100 text-zinc-700 border border-zinc-200 shrink-0">
                      {pet.breed || 'Companion Animal'}
                    </span>
                  </div>
                  <p className="text-[11px] sm:text-xs text-zinc-500 mt-0.5 leading-relaxed break-words">
                    {Math.round((pet.ageMonths || 36) / 12)} yrs old • {pet.weightKg || 28.5} kg • Owner:{' '}
                    <span className="text-zinc-700 font-medium break-all">{userEmail}</span>
                  </p>
                </div>
              </div>
            ...
            <div className="px-4 sm:px-6 py-2.5 sm:py-3 bg-[#FAFBFB] border-b border-zinc-100 flex flex-wrap items-center justify-between gap-2.5 text-xs">
              <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 text-zinc-600">
              ...
              <div className="flex items-center gap-1.5 text-zinc-500 text-[11px]">
                <span>Pass ID:</span>
                <span className="font-mono font-bold text-zinc-800 break-all">{passId}</span>
              </div>
            </div>

            {/* Microchip Specs Grid */}
            <div className="p-4 sm:p-6 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="p-3 sm:p-3.5 rounded-xl bg-zinc-50/70 border border-zinc-200/70">
          ...
          <div className="bg-white rounded-2xl border border-zinc-200/80 shadow-xs overflow-hidden">
            <div className="p-4 sm:p-5 border-b border-zinc-100 flex flex-col sm:flex-row sm:items-center justify-between gap-1.5">
              <div>
            ...
            <div className="sm:hidden px-4 py-2 bg-zinc-50/90 border-b border-zinc-100 flex items-center justify-between text-[10px] text-zinc-500 font-medium">
              <span className="flex items-center gap-1.5">
                <svg className="w-3.5 h-3.5 text-zinc-400 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                </svg>
                Swipe table horizontally
              </span>
              <span className="text-zinc-400">4 Records</span>
            </div>
        ...
        <div className="lg:col-span-4 space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-zinc-200/80 shadow-xs p-4 sm:p-6 text-center">
