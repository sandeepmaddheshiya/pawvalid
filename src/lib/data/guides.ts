...
export const GUIDES: RegulatoryGuide[] = [
  {
    ...
    title: 'Rabies Titer Test (FAVN) Guide: Cost, Rules & Wait Times by Country (2026)',
    seoTitle: 'Rabies Titer Test (FAVN) Guide: Cost, Rules & Wait Times by Country (2026) | PawValid',
    description:
      'Step-by-step rabies titer test (FAVN) guide: blood draw timing, accredited lab fees, 0.50 IU/mL antibody thresholds, and 180-day waiting rules by destination country.',
    readTime: '9 min read',
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          'For travelers exporting pets from the United States, obtaining federal endorsement via [USDA APHIS VEHCS endorsement](/en/guides/usda-aphis-vehcs-guide) is also mandatory once titer results are received.',
        ],
        table: {
          headers: ['Destination Jurisdiction', 'Titer Status', 'Mandatory Post-Draw Waiting Period', 'Key Biosecurity Authority'],
          rows: [
            ['[Singapore](/en/countries/singapore) (Category C & D Origins e.g., USA, Canada, India)', 'Mandatory (≥ 0.5 IU/mL)', '30 Days to 6 Months prior to export (30-day CAPQ quarantine)', 'Singapore AVS / NParks'],
            ['[European Union](/en/countries/germany) (from US/UK/Canada)', 'Exempt / Not Required', '0 Days (US is Annex II listed third country)', 'European Commission DG SANTE'],
            ['[European Union](/en/countries/france) (from Unlisted Countries e.g., Turkey, India, Egypt)', 'Mandatory (≥ 0.5 IU/mL)', '3 Months (90 Days) post-draw waiting period before EU entry', 'Regulation (EU) No 576/2013'],
            ['[Japan](/en/countries/japan)', 'Mandatory (FAVN)', '180 Days post-draw latency (0-day quarantine if compliant)', 'Japan MAFF Animal Quarantine Service'],
            ['[Australia](/en/countries/australia)', 'Mandatory (RNATT)', '180 Days post-draw for 10-day PEQ facility stay', 'Australian DAFF Biosecurity'],
            ...
            ['[Hawaii / United States](/en/countries/united-states) (Direct Airport Release)', 'Mandatory (FAVN)', '30 Days post-draw arrival window', 'Hawaii Department of Agriculture (HDOA)'],
            ['[United Arab Emirates](/en/countries/united-arab-emirates) (Dubai / Abu Dhabi)', 'Mandatory (RNATT)', 'At least 12 weeks before entry', 'MOCCAE UAE'],
          ],
        },
      },
      {
      ...
      },
      {
        ...
        content: [
          ...
          '4. Missing government endorsement: Having a passed titer report does not bypass the need for an official sovereign export health certificate (such as [USDA APHIS VEHCS endorsement](/en/guides/usda-aphis-vehcs-guide) for US departures).',
        ],
      },
    ],
    steps: [
  ...
  {
    slug: 'usda-aphis-vehcs-guide',
    title: 'USDA Pet Health Certificate: What It Is & How to Get One (2026)',
    seoTitle: 'USDA Pet Health Certificate: What It Is & How to Get One (2026) | PawValid',
    description:
      'Step-by-step guide to the USDA pet health certificate: who needs it, the 10-day rule, fees, and how to avoid rejection at the border.',
    readTime: '8 min read',
    category: 'Government Endorsement',
    dateModified: '2026-09-21',
    lastReviewedDate: '2026-09-21',
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ['[European Union](/en/countries/germany) (Germany, France, Spain, Italy, etc.)', 'Digital VEHCS PDF with cryptographic watermark', '24 – 48 Hours', 'No (Digital printout accepted at EU borders)'],
            ['[United Kingdom](/en/countries/united-kingdom) (England, Scotland, Wales)', 'Digital VEHCS with official QR validation', '24 – 48 Hours', 'No (Digital printout accepted at HARC / Gatwick)'],
            ['[Singapore](/en/countries/singapore) (AVS / NParks)', 'Digital or physical endorsed AVS certificate', '24 – 48 Hours', 'No (Printout accepted with GoBusiness Licence)'],
            ['[Japan](/en/countries/japan) (MAFF AQS)', 'Physical embossed ink raised seal', '3 – 5 Business Days', 'Yes (Must ship via FedEx overnight with return envelope)'],
            ['[Australia](/en/countries/australia) (DAFF)', 'Physical embossed ink seal + electronic pre-clearance', '3 – 5 Business Days', 'Yes (Must be physically attached to crate exterior)'],
            ['[Canada](/en/countries/canada) (CFIA)', 'Standard rabies certificate (USDA endorsement exempt for personal dogs)', 'Instant', 'No USDA endorsement required for personal pet travel to [Canada](/en/countries/canada) (exempt under CFIA regulations)'],
          ],
        },
      },
      {
      ...
      },
      {
        ...
        content: [
          ...
          '6. Missing [rabies titer test requirements](/en/guides/rabies-titer-test-favn-guide) laboratory documentation for destinations requiring blood tests.',
        ],
      },
    ],
    steps: [
  ...
  {
    slug: 'iata-crate-requirements',
    title: 'IATA Pet Crate Requirements: Sizing Rules & Checklist (2026)',
    seoTitle: 'IATA Pet Crate Requirements: Sizing Rules & Checklist (2026) | PawValid',
    description:
      'Exact IATA-approved crate dimensions and requirements for flying with your dog or cat, plus a printable pre-flight checklist.',
  ...
  },
  {
    ...
    description:
      'The EU Annex IV certificate is required for non-commercial pet entry from third countries. See why general AI miscalculates 21-day rabies latency windows vs deterministic compliance checking.',
    readTime: '7 min read',
    category: 'Regulatory Intelligence',
    dateModified: '2026-09-21',
    lastReviewedDate: '2026-09-21',
